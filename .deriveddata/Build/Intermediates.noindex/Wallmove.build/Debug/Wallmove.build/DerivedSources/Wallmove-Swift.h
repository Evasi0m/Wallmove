...
#ifndef WALLMOVE_SWIFT_H
#define WALLMOVE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Wallmove",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8Wallmove22DesktopWallpaperWindow")
@interface DesktopWallpaperWindow : NSWindow
...
@class NSCoder;
SWIFT_CLASS("_TtC8Wallmove15PlayerLayerView")
